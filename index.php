...
<div id="contentwrapper">
	...
	<!--<div id="sidebarHeader"><span class="data_icon"><img src="images/book.png" align="absmiddle"></span><span class="data">OG</span></div>-->
			<table class="dataTable" style="font-size:15px;margin-top:10px;">
